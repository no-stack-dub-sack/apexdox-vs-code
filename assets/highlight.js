...
var hljs = function () {
	...
	const o = e => !!e.scope || e.sublanguage && e.language; class a {
		constructor(e, t) {
	...
	function f(...e) { return e.map((e => d(e))).join("") } function b(...e) {
		const t = (e => {
	...
	const E = /\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./
		; function x(e, { joinWith: t }) {
			let n = 0; return e.map((e => {
				n += 1; const t = n
					; let i = d(e), r = ""; for (; i.length > 0;) {
						const e = E.exec(i); if (!e) { r += i; break }
	...
	const w = "[a-zA-Z]\\w*", y = "[a-zA-Z_]\\w*", _ = "\\b\\d+(\\.\\d+)?", O = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", v = "\\b(0b[01]+)", N = {
		...
		NUMBER_MODE: { scope: "number", begin: _, relevance: 0 }, C_NUMBER_MODE: {
			scope: "number",
			begin: O, relevance: 0
				...
				if (Array.isArray(e.begin)) {
					if (e.skip || e.excludeBegin || e.returnBegin) throw W("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),
						...
						; if ("object" != typeof e.beginScope || null === e.beginScope) throw W("beginScope must be object"),
							Z; F(e, e.begin, { key: "beginScope" }), e.begin = x(e.begin, { joinWith: "" })
				}
			})(e), (e => {
				if (Array.isArray(e.end)) {
					if (e.skip || e.excludeEnd || e.returnEnd) throw W("skip, excludeEnd, returnEnd not compatible with endScope: {}"),
						...
						; if ("object" != typeof e.endScope || null === e.endScope) throw W("endScope must be object"),
							Z; F(e, e.end, { key: "endScope" }), e.end = x(e.end, { joinWith: "" })
				}
			})(e)
		} function q(e) {
			function t(t, n) {
				...
				addRule(e, t) {
					...
					; const e = this.regexes.map((e => e[1])); this.matcherRe = t(x(e, {
						joinWith: "|"
					}), !0), this.lastIndex = 0
				} exec(e) {
					...
					; if (r.isCompiled) return a
						...
						; return "object" == typeof r.keywords && r.keywords.$pattern && (r.keywords = Object.assign({}, r.keywords),
							...
							r.contains || (r.contains = []), r.contains = [].concat(...r.contains.map((e => (e => (e.variants && !e.cachedVariants && (e.cachedVariants = e.variants.map((t => s(e, {
								variants: null
							}, t)))), e.cachedVariants ? e.cachedVariants : J(e) ? s(e, {
	...
	const Q = r, ee = s, te = Symbol("nomatch"); var ne = (e => {
		const t = Object.create(null), r = Object.create(null), s = []; let o = !0
			; const a = "Could not find the language '{}', did you forget to load/include a language module?", c = {
				...
				cssSelector: "pre code", languages: null, __emitter: g
			}; function d(e) {
				...
				const c = Object.create(null); function g() {
					...
					if (m = s, "begin" === s.type) return (e => {
						...
						; if ("illegal" === s.type && !r) {
							const e = Error('Illegal lexeme "' + a + '" for mode "' + (N.scope || "<unnamed>") + '"')
								; throw e.mode = N, e
						} if ("end" === s.type) { const e = b(s); if (e !== te) return e }
					if ("illegal" === s.type && "" === a) return 1
						; if (A > 1e5 && A > 3 * s.index) throw Error("potential infinite loop, way more iterations than matches")
							; return S += a, a.length
				} const y = O(e)
					; if (!y) throw W(a.replace("{}", e)), Error('Unknown language: "' + e + '"')
						; const _ = q(y); let v = "", N = s || _; const k = {}, M = new l.__emitter(l); (() => {
							const e = []
				...
				n = n || l.languages || Object.keys(t); const i = (e => {
					...
					; return g.secondBest = a, g
			} function w(e) {
				let t = null; const n = (e => {
					let t = e.className + " "; t += e.parentNode ? e.parentNode.className : ""
						; const n = l.languageDetectRe.exec(t); if (n) {
							const t = O(n[1])
		...
		"undefined" != typeof window && window.addEventListener && window.addEventListener("DOMContentLoaded", (() => {
			...
			autoDetection: N, inherit: ee, addPlugin: e => {
				(e => {
			...
			concat: f, lookahead: u, either: b, optional: p,
			anyNumberOfTimes: h
		}; for (const e in I) "object" == typeof I[e] && n(I[e])
...
(() => {
	var e = (() => {
		"use strict"; return e => {
			const s = e.regex, t = "[a-zA-Z][a-zA-Z_0-9]*", a = {
				scope: "number", variants: [{
					match: /\b[0-9]+(?:\.[0-9]+)?/
				}, { match: /\s(?:[0-9,]+)?\.[0-9]+/ }], relevance: 0
			}, c = {
				...
				relevance: 10
			}, { match: [t, s.lookahead(/\s*\[\]/)], scope: { 1: "type" } }], E = {
				...
				}], contains: [r, o, e.APOS_STRING_MODE], relevance: 0
			}, d = {
				begin: /\[[\s\n]*(?=SELECT)/, end: /\]/, scope: "subst", relevance: 10, contains: [{
					...
					relevance: 0
				}, { match: /\b[a-zA-Z][a-zA-Z_0-9]*\b/, scope: "property" }, a, A],
				illegal: "::"
			}; return {
				name: "Apex", aliases: ["apex", "lightning"],
				...
				contains: [i, [{
					match: [/\b(?<=enum|\bnew)/, /\s+/, t, /\s*(?=[{()])/], scope: {
						3: "type"
					}, contains: [r, o, E]
				}, {
					match: [/\bclass/, /\s+/, t], scope: {
						1: "keyword",
						3: "title.class"
					}
				}, {
					match: [/(?<=public)/, /\s+/, t, /(?=\s*\()/], scope: {
						3: "constructor"
					}
				}, {
					begin: [/\btrigger/, /\s+/, t, /\s+/, "on", /\s+/, t], end: "{",
					scope: { 1: "keyword", 3: "title.class", 7: "type" }, contains: [r, o, {
						match: /(?:before|after)\s+(?:insert|update|delete|undelete)/, scope: "built_in",
						relevance: 10
					}], relevance: 10
				}, {
					match: [/\bextends/, /\s+/, t], scope: {
						3: "title.class.inherited"
					}, contains: [r, o, n], illegal: [/\b_/, /_\b/]
				}], [{
					match: [t, /\s+/, t, /\s+/, /=/], scope: { 1: "type", 3: "variable", 5: "operator" },
					relevance: 0
				}, {
					match: [t, /\s+/, t, /\s+/, ";"], scope: { 1: "type", 3: "variable" },
					relevance: 0
				}, {
					match: [/\s+/, t, /\s+/, /=/], scope: { 2: "variable", 4: "operator" },
					relevance: 0
				}, {
					match: [/(?<=\w+\s+=\s+\()/, t, /(?=\))/], scope: { 2: "type" },
					relevance: 0
				}], {
					relevance: 10, match: [/\b(?:with|without|inherited)\s+sharing/],
						scope: { 1: "keyword" }
					}, p, b, o, r, {
						match: /\b(switch\s+on|as\s+user|as\s+system)\b/,
						relevance: 8, scope: "keyword"
					}, E, l, {
						variants: [{
