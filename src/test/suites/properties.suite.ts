...
export const createPropertiesSuite = (files: ITestFile[]) => {
  suite('Properties', function () {
    ...
    test('Should not have description column if no properties are doc-block annotated', function () {
      ...
      const descriptionHeader = $('th', '.subsection.properties.TEST_Properties_InnerTwo')
        .toArray()
        .filter((el) => $(el).text() === 'Description');
    ...
    test('Should have description column if any property is doc-block annotated', function () {
      ...
      const descriptionHeader = $('th', '.subsection.properties.TEST_Properties_InnerOne')
        .toArray()
        .filter((el) => $(el).text() === 'Description');
    ...
    test('Should not have annotation column if no properties have Apex annotations', function () {
      ...
      const annotationHeader = $('th', '.subsection.properties.TEST_Properties_InnerOne')
        .toArray()
        .filter((el) => $(el).text() === 'Annotations');
    ...
    test('Should have description column if any property is doc-block annotated', function () {
      ...
      const annotationHeader = $('th', '.subsection.properties.TEST_Properties_InnerTwo')
        .toArray()
        .filter((el) => $(el).text() === 'Annotations');
    ...
    test('Should have description and annotation column if properties have at least one doc-block and Apex annotation ', function () {
      ...
      const annotationHeader = $('th', '.subsection.properties.TEST_Properties_InnerThree')
        .toArray()
        .filter((el) => $(el).text() === 'Annotations');
      const descriptionHeader = $('th', '.subsection.properties.TEST_Properties_InnerThree')
        .toArray()
        .filter((el) => $(el).text() === 'Description');
