        ...
        <td class="contentTD">
          <details class="section" open>
            ...
            <div class="class-details">
              <div class="">The <code class="code-inline">BotField</code> class. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad veniam, quis nostrud exercitation ullamco laboris nis.</div>
              <div class="class-subtitle ">See</div>
              <div class="class-subtitle-description"><a target="_blank" rel="noopener noreferrer" href="https://github.com/dreamhouseapp/dreamhouse-sfdx/blob/master/LICENSE">License</a>, <a target="_blank" rel="noopener noreferrer" href="https://github.com/dreamhouseapp/dreamhouse-sfdx">Github</a>, <span title="A valid link could not be created with this identifier.">TEST_BotController</span>, <span title="A valid link could not be created with this identifier.">TEST_BotRecord</span></div><br />Salesforce.com<br />Jul 2017<div class="class-subtitle ">Example</div>
...
records.add(new BotRecord(fields)); 
            ...
            <tr class="property public">
                <td class="attribute-name">value</td>
                <td class="attribute-signature">
            ...
            <details class="subsection methods" open>
                ...
                <div class="method public"><h2 class="method-title " id="TEST_BotField.BotField">BotField</h2>
            <div class="method-signature">
              ...
              <div class="method public">
                <h2 class="method-title " id="TEST_BotField.BotField_1">BotField</h2>
                <div class="method-signature">
