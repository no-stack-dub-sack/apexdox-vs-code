              ...
              <div class="methods-container">
                <ul class="methods-toc">
                  <li class="method global">
                    <a class="methods-toc__entry " href="#TEST_InterfaceClass.doIt">
                      doIt
                    </a></li>
                  <li class="method global">
                    <a class="methods-toc__entry " href="#TEST_InterfaceClass.doSomething">
                      doSomething
                    </a></li>
                  <li class="method global">
                    <a class="methods-toc__entry " href="#TEST_InterfaceClass.doSomethingElse">
                      doSomethingElse
                    </a></li>
                </ul>
                <div class="method global">
                  <h2 class="method-title " id="TEST_InterfaceClass.doIt">doIt</h2>
                ...
                <div class="method global">
                  <h2 class="method-title " id="TEST_InterfaceClass.doSomething">doSomething</h2>
                  <div class="method-signature">
                ...
                <div class="method global">
                  <h2 class="method-title " id="TEST_InterfaceClass.doSomethingElse">doSomethingElse</h2>
                  <div class="method-signature">
