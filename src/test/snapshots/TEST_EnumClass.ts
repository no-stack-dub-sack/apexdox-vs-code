  ...
  <body>
    ...
    <table width="100%">
      ...
      <tr style="vertical-align:top;">
        ...
        <td class="contentTD">
          <h2 class="sectionTitle" id="TEST_EnumClass">

            <a target="_blank" rel="noopener noreferrer" title="Go to source" class="hostedSourceLink" href="https://somefakeurl.com/TEST_EnumClass.cls#L8">
              TEST_EnumClass
          ...
          <div class="classDetails">
            <div class="">Our documentation engine should correctly parse these values.</div>
            <p />
