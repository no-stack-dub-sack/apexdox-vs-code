          ...
          <div class="section">
            ...
            <div class="class-container">
              ...
              <div class="class-description">
                The <code class="code-inline">SampleDataController</code> class. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad veniam, quis nostrud exercitation ullamco laboris nis.
              </div>
            ...
            <div class="subsection methods">
              <h3 class="subsection-title methods">TEST_SampleDataController Methods</h3>
              <div class="methods-container">
                ...
                <div class="method public">
                  ...
                  <div class="param-name">param1</div>
                  <div class="param-description">param description 1</div>
                  <div class="param-name">param2</div>
                  <div class="param-description">param description 2</div>
                  <div class="param-name">param3</div>
                  <div class="param-description">param description 3</div>
                </div>
              </div>
            </div>
          </div>
