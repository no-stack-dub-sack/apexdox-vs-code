      ...
      <tr style="vertical-align:top;">
        ...
        <td class="contentTD">
          <details class="section" open>
            <summary>
              <h2 class="sectionTitle" id="TEST_SampleDataController">

                <a target="_blank" rel="noopener noreferrer" title="Go to source" class="source-link" href="https://somefakeurl.com/TEST_SampleDataController.cls#L12">
            ...
            <div class="class-details">
              <div class="">The <code class="code-inline">SampleDataController</code> class. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad veniam, quis nostrud exercitation ullamco laboris nis.</div>
              ...
              <div class="methods-container">
                <ul class="methods-toc">
                  <li class="method public">
                    <a class="methods-toc__entry " href="#TEST_SampleDataController.importSampleData">
                      importSampleData
                    </a>
                    <div class="methods-toc__description">Method has incorrect params. Just needed a test file with one method to test param tags.</div>
                  </li>
                </ul>
                <div class="method public">
                  <h2 class="method-title " id="TEST_SampleDataController.importSampleData">importSampleData</h2>
                  <div class="method-annotations">@AuraEnabled</div>
                  <div class="method-signature">

                    <a target="_blank" rel="noopener noreferrer" title="Go to source" class="source-link" href="https://somefakeurl.com/TEST_SampleDataController.cls#L21">
                      public static void <span class="hljs-title">importSampleData</span>()
                    </a>
                  </div>
                  <div class="method-description">Method has incorrect params. Just needed a test file with one method to test param tags.</div>
