      ...
      <tr style="vertical-align:top;">
        ...
        <td class="contentTD">
          <details class="section" open>
            <summary>
              <h2 class="sectionTitle" id="TEST_BotItem">

                <a target="_blank" rel="noopener noreferrer" title="Go to source" class="source-link" href="https://somefakeurl.com/TEST_BotItem.cls#L12">
                  TEST_BotItem
            ...
            <div class="class-details">
              <div class="">The <code class="code-inline">BotItem</code> class. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad veniam, quis nostrud exercitation ullamco laboris nis.</div>
              ...
              <div class="subsection-container">
                <table class="attributes-table properties">
                  ...
                  <tr class="property public">
                    <td class="attribute-name">linkURL</td>
            ...
            <details class="subsection methods" open>
                ...
                <a class="methods-toc__entry " href="#TEST_BotItem.BotItem">
                    BotItem
                </a><div class="methods-toc__description">Convenience constructor to create a single item</div></li><li class="method public">
                <a class="methods-toc__entry " href="#TEST_BotItem.BotItem_1">
                    BotItem
                </a><div class="methods-toc__description">Convenience constructor to create a single item</div></li></ul>
                <div class="method public"><h2 class="method-title " id="TEST_BotItem.BotItem">BotItem</h2>
            <div class="method-signature">
                
                <a target="_blank" rel="noopener noreferrer" title="Go to source" class="source-link" href="https://somefakeurl.com/TEST_BotItem.cls#L21">
                    public <span class="hljs-title">BotItem</span>(String name)
                      </a>
              </div>
              <div class="method-description">Convenience constructor to create a single item</div>
              <div class="method-subtitle">Parameters</div>
              <div class="paramName">name</div>
              <div class="paramDescription">The <code class="code-inline">BotItem</code>s name</div>
              </div>
              <div class="method public">
                <h2 class="method-title " id="TEST_BotItem.BotItem_1">BotItem</h2>
                <div class="method-signature">

                  <a target="_blank" rel="noopener noreferrer" title="Go to source" class="source-link" href="https://somefakeurl.com/TEST_BotItem.cls#L30">
                    public <span class="hljs-title">BotItem</span>(String name, string linkURL)
                  </a>
                </div>
                <div class="method-description">Convenience constructor to create a single item</div>
                <div class="method-subtitle">Parameters</div>
                <div class="paramName">name</div>
                <div class="paramDescription">The <code class="code-inline">BotItem</code>s name</div>
                <div class="paramName">linkURL</div>
                <div class="paramDescription">The <code class="code-inline">BotItem</code>s link</div>
              </div>
              </div>
            </details>
          </details>
