          ...
          <details class="section" open>
            <summary>
              <h2 class="sectionTitle" id="TEST_ISObjectComparator">
                ...
                <a target="_blank" rel="noopener noreferrer" title="Go to source" class="source-link" href="https://somefakeurl.com/TEST_ISObjectComparator.cls#L25">
            ...
            <div class="class-details">
              <div class="">The apex-lang <code class="code-inline">ISObjectComparator</code> interface. The classes in this group have been randomly gathered from various resources simply to demonstrate ApexDoc2-VSCode&#39;s multi-source directory feature aimed at Salesforce-DX projects which may have a <code class="code-inline">main</code> folder and multipke feature directories. <br><br> This code is part of the &#39;apex-lang&#39; open source project avaiable at: http://code.google.com/p/apex-lang/. This code is licensed under the Apache License, Version 2.0. You may obtain a copy of the License at: http://www.apache.org/licenses/LICENSE-2.0.</div>
              ...
              <div class="methods-container">
                <ul class="methods-toc">
                  <li class="method global">
                    <a class="methods-toc__entry " href="#TEST_ISObjectComparator.compare">
                      compare
                    </a></li>
                </ul>
                <div class="method global">
                  <h2 class="method-title " id="TEST_ISObjectComparator.compare">compare</h2>
                  <div class="method-signature">

                    <a target="_blank" rel="noopener noreferrer" title="Go to source" class="source-link" href="https://somefakeurl.com/TEST_ISObjectComparator.cls#L26">
