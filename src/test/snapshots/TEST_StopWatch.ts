        ...
        <td class="contentTD">
          <details class="section" open>
            ...
            <div class="class-details">
              <div class="">The apex-lang <code class="code-inline">StopWatch</code> utility class for Apex. The classes in this group have been randomly gathered from various resources simply to demonstrate ApexDoc2-VSCode&#39;s multi-source directory feature aimed at Salesforce-DX projects which may have a <code class="code-inline">main</code> folder and multipke feature directories. <br><br> This code is part of the &#39;apex-lang&#39; open source project avaiable at: http://code.google.com/p/apex-lang/. This code is licensed under the Apache License, Version 2.0. You may obtain a copy of the License at: http://www.apache.org/licenses/LICENSE-2.0.</div>
              ...
              <div class="subsection-container">
                <table class="attributes-table properties">
                  ...
                  <tr class="property private">
                    <td class="attribute-name">runningState</td>
            ...
            <tr class="property private">
                <td class="attribute-name">splitState</td>
                <td class="attribute-signature">
            ...
            <tr class="property private">
                <td class="attribute-name">startTime</td>
                <td class="attribute-signature">
            ...
            <tr class="property private">
                <td class="attribute-name">STATE_RUNNING</td>
                <td class="attribute-signature">
            ...
            <tr class="property private">
                <td class="attribute-name">STATE_SPLIT</td>
                <td class="attribute-signature">
            ...
            <tr class="property private">
                <td class="attribute-name">STATE_STOPPED</td>
                <td class="attribute-signature">
            ...
            <tr class="property private">
                <td class="attribute-name">STATE_SUSPENDED</td>
                <td class="attribute-signature">
            ...
            <tr class="property private">
                <td class="attribute-name">STATE_UNSPLIT</td>
                <td class="attribute-signature">
            ...
            <tr class="property private">
                <td class="attribute-name">STATE_UNSTARTED</td>
                <td class="attribute-signature">
            ...
            <tr class="property private">
                <td class="attribute-name">stopTime</td>
                <td class="attribute-signature">
            ...
            <details class="subsection methods" open>
                ...
                <a class="methods-toc__entry " href="#TEST_StopWatch.getSplitTime">
                    getSplitTime
                </a><div class="methods-toc__description">Call this method to get split time.</div></li><li class="method global">
                <a class="methods-toc__entry " href="#TEST_StopWatch.getStartTime">
                    getStartTime
                </a><div class="methods-toc__description">Call this method to get the start time.</div></li><li class="method global">
                <a class="methods-toc__entry " href="#TEST_StopWatch.getTime">
                    getTime
                </a><div class="methods-toc__description">Call this method to get the current time.</div></li><li class="method global">
                <a class="methods-toc__entry " href="#TEST_StopWatch.reset">
                    reset
                </a><div class="methods-toc__description">Call this method to reset the stopwatch.</div></li><li class="method global">
                <a class="methods-toc__entry " href="#TEST_StopWatch.resume">
                    resume
                </a><div class="methods-toc__description">Call this method to resume the stopwatch.</div></li><li class="method global">
                <a class="methods-toc__entry " href="#TEST_StopWatch.split">
                    split
                </a><div class="methods-toc__description">Call this method to split the stopwatch.</div></li><li class="method global">
                <a class="methods-toc__entry " href="#TEST_StopWatch.start">
                    start
                </a><div class="methods-toc__description">Call this method to start the stopwatch.</div></li><li class="method global">
                <a class="methods-toc__entry " href="#TEST_StopWatch.stop">
                    stop
                </a><div class="methods-toc__description">Call this method to stop the stopwatch.</div></li><li class="method global">
                <a class="methods-toc__entry " href="#TEST_StopWatch.suspend">
                    suspend
                </a><div class="methods-toc__description">Call this method to suspend the stopwatch.</div></li><li class="method global">
                <a class="methods-toc__entry " href="#TEST_StopWatch.toSplitString">
                    toSplitString
                </a><div class="methods-toc__description">Call this method to get the split time as a string.</div></li><li class="method global">
                <a class="methods-toc__entry " href="#TEST_StopWatch.toStr">
                    toStr
                </a><div class="methods-toc__description">Call this method to get the time as a string.</div></li><li class="method global">
                <a class="methods-toc__entry " href="#TEST_StopWatch.unsplit">
                    unsplit
                </a><div class="methods-toc__description">Call this method to unsplit the stopwatch.</div></li></ul>
                <div class="method global"><h2 class="method-title " id="TEST_StopWatch.getSplitTime">getSplitTime</h2>
            <div class="method-signature">
              ...
              <div class="method-description">Call this method to get split time.</div>
              <div class="method-subtitle ">Exceptions</div>
              <div class="method-subtitle-description">Throws <code class="code-inline">IllegalStateException</code></div>
              </div>
              <div class="method global">
                <h2 class="method-title " id="TEST_StopWatch.getStartTime">getStartTime</h2>
                <div class="method-signature">
                ...
                <div class="method-description">Call this method to get the start time.</div>
                <div class="method-subtitle ">Exceptions</div>
                <div class="method-subtitle-description">Throws <code class="code-inline">IllegalStateException</code></div>
              </div>
              <div class="method global">
                <h2 class="method-title " id="TEST_StopWatch.getTime">getTime</h2>
                <div class="method-signature">
                ...
                <div class="method-description">Call this method to get the current time.</div>
              </div>
              <div class="method global">
                <h2 class="method-title " id="TEST_StopWatch.reset">reset</h2>
                <div class="method-signature">
                ...
                <div class="method-description">Call this method to reset the stopwatch.</div>
              </div>
              <div class="method global">
                <h2 class="method-title " id="TEST_StopWatch.resume">resume</h2>
                <div class="method-signature">
                ...
                <div class="method-description">Call this method to resume the stopwatch.</div>
                <div class="method-subtitle ">Exceptions</div>
                <div class="method-subtitle-description">Throws <code class="code-inline">IllegalStateException</code></div>
              </div>
              <div class="method global">
                <h2 class="method-title " id="TEST_StopWatch.split">split</h2>
                <div class="method-signature">
                ...
                <div class="method-description">Call this method to split the stopwatch.</div>
                <div class="method-subtitle ">Exceptions</div>
                <div class="method-subtitle-description">Throws <code class="code-inline">IllegalStateException</code></div>
              </div>
              <div class="method global">
                <h2 class="method-title " id="TEST_StopWatch.start">start</h2>
                <div class="method-signature">
                ...
                <div class="method-description">Call this method to start the stopwatch.</div>
                <div class="method-subtitle ">Exceptions</div>
                <div class="method-subtitle-description">Throws <code class="code-inline">IllegalStateException</code></div>
              </div>
              <div class="method global">
                <h2 class="method-title " id="TEST_StopWatch.stop">stop</h2>
                <div class="method-signature">
                ...
                <div class="method-description">Call this method to stop the stopwatch.</div>
                <div class="method-subtitle ">Exceptions</div>
                <div class="method-subtitle-description">Throws <code class="code-inline">IllegalStateException</code></div>
              </div>
              <div class="method global">
                <h2 class="method-title " id="TEST_StopWatch.suspend">suspend</h2>
                <div class="method-signature">
                ...
                <div class="method-description">Call this method to suspend the stopwatch.</div>
                <div class="method-subtitle ">Exceptions</div>
                <div class="method-subtitle-description">Throws <code class="code-inline">IllegalStateException</code></div>
              </div>
              <div class="method global">
                <h2 class="method-title " id="TEST_StopWatch.toSplitString">toSplitString</h2>
                <div class="method-signature">
                ...
                <div class="method-description">Call this method to get the split time as a string.</div>
              </div>
              <div class="method global">
                <h2 class="method-title " id="TEST_StopWatch.toStr">toStr</h2>
                <div class="method-signature">
                ...
                <div class="method-description">Call this method to get the time as a string.</div>
              </div>
              <div class="method global">
                <h2 class="method-title " id="TEST_StopWatch.unsplit">unsplit</h2>
                <div class="method-signature">
                ...
                <div class="method-description">Call this method to unsplit the stopwatch.</div>
                <div class="method-subtitle ">Exceptions</div>
                <div class="method-subtitle-description">Throws <code class="code-inline">IllegalStateException</code></div>
              </div>
              </div>
