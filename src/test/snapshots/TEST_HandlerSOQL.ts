      ...
      <tr style="vertical-align:top;">
        ...
        <td class="contentTD">
          <details class="section" open>
            <summary>
              <h2 class="sectionTitle" id="TEST_HandlerSOQL">

                <a target="_blank" rel="noopener noreferrer" title="Go to source" class="source-link" href="https://somefakeurl.com/TEST_HandlerSOQL.cls#L10">
                  TEST_HandlerSOQL
            ...
            <div class="class-details">
              <div class="">Handle SOQL <code class="code-inline">BotHandler</code> implementation.</div>
              <div class="class-subtitle ">See</div>
              <div class="class-subtitle-description"><a href="javascript:void(0)" onclick="goToLocation('TEST_BotHandler.html')">TEST_BotHandler</a>, <a target="_blank" rel="noopener noreferrer" href="https://github.com/dreamhouseapp/dreamhouse-sfdx/blob/master/LICENSE">License</a>, <a target="_blank" rel="noopener noreferrer" href="https://github.com/dreamhouseapp/dreamhouse-sfdx">Github</a></div><br />Salesforce.com<br />Jul 2017
            </div>
            <p />
              ...
              <div class="methods-container">
                <ul class="methods-toc">
                  <li class="method public">
                    <a class="methods-toc__entry " href="#TEST_HandlerSOQL.handle">
                      handle
                    </a></li>
                </ul>
                <div class="method public">
                  <h2 class="method-title " id="TEST_HandlerSOQL.handle">handle</h2>
                  <div class="method-signature">

                    <a target="_blank" rel="noopener noreferrer" title="Go to source" class="source-link" href="https://somefakeurl.com/TEST_HandlerSOQL.cls#L12">
                      public BotResponse <span class="hljs-title">handle</span>(String utterance, String[] params, Map&lt;String, String&gt; session, String fileName, String fileContent)
                    </a>
                  </div>
                </div>
              </div>
