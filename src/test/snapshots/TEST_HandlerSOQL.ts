          ...
          <details class="section" open>
            <summary>
              <h2 class="sectionTitle" id="TEST_HandlerSOQL">
                ...
                <a target="_blank" rel="noopener noreferrer" title="Go to source" class="hostedSourceLink" href="https://somefakeurl.com/TEST_HandlerSOQL.cls#L10">
                  TEST_HandlerSOQL
              ...
              <div class="methodsContainer">
                <ul class="methodTOC">
                  <li class="method undefined">
                    <a class="methodTOCEntry " href="#TEST_HandlerSOQL.handle">
                      handle
                    </a></li>
                </ul>
                <div class="method undefined">
                  <h2 class="methodHeader " id="TEST_HandlerSOQL.handle">handle</h2>
                  <div class="methodSignature">

                    <a target="_blank" rel="noopener noreferrer" title="Go to source" class="hostedSourceLink" href="https://somefakeurl.com/TEST_HandlerSOQL.cls#L12">
