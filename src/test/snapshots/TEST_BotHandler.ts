        ...
        <td class="contentTD">
          <details class="section" open>
            ...
            <div class="class-details">
              <div class="">The <code class="code-inline">BotHandler</code> class. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad veniam, quis nostrud exercitation ullamco laboris nis.</div>
              ...
              <div class="methods-container">
                <ul class="methods-toc">
                  <li class="method public">
                    ...
                    <div class="methods-toc__description">The handle method for this interface which handles some stuff.</div>
                  </li>
                </ul>
                <div class="method public">
                  <h2 class="method-title " id="TEST_BotHandler.handle">handle</h2>
                  ...
                  <div class="method-description">The handle method for this interface which handles some stuff.</div>
                  ...
                  <div class="method-subtitle-description">Looks like it returns a <code class="code-inline">BotResponse</code> instance.</div>
                  <div class="method-subtitle ">See</div>
                  <div class="method-subtitle-description"><span title="A valid link could not be created with this identifier.">TEST_BotController.submit</span></div>
                </div>
              </div>
            </details>
          </details>
