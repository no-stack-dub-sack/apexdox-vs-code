        ...
        <td class="doc-page">
          ...
          <div class="section">
            ...
            <h2 class="class-title top-level-type" id="TEST_BotHandler">
              ...
              <a target="_blank" rel="noopener noreferrer" title="Go to source" class="source-link" href="https://somehost.com/some-user/some-repo/tree/main/src/feature1/subFolder1/TEST_BotHandler.cls#L16">
                TEST_BotHandler
              </a>
            </h2>
              ...
              <div class="methods-container">
                ...
                <div class="method public">
                  <h4 class="method-title " id="TEST_BotHandler.handle">
                    ...
                    <a target="_blank" rel="noopener noreferrer" title="Go to source" class="source-link" href="https://somehost.com/some-user/some-repo/tree/main/src/feature1/subFolder1/TEST_BotHandler.cls#L30">
                      handle(utterance, params, session, fileName, fileContent)
                    </a>
                  </h4>
