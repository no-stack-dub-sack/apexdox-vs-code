      ...
      <tr style="vertical-align:top;">
        ...
        <td class="contentTD">
          <details class="section" open>
            <summary>
              <h2 class="sectionTitle" id="IncludeOne">

                <a target="_blank" rel="noopener noreferrer" title="Go to source" class="source-link" href="https://somefakeurl.com/IncludeOne.cls#L6">
                  IncludeOne
            ...
            <div class="class-details">
              <div class="">This class should be included by <code class="code-inline">apexdoc2.engine.includes</code> setting</div><br />P. Weinberg<br />2019
            </div>
            <p />
          </details>
          </div>
