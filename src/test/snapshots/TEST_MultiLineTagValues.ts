          ...
          <div class="section">
            ...
            <div class="class-container">
              ...
              <div class="class-description">
                Testing that the following tags support values of multiple lines as they&#39;re supposed to. Doesn&#39;t matter if on class or method, code that handles both is the same.
              </div>
            ...
            <div class="subsection methods">
              ...
              <div class="methods-container">
                ...
                <div class="method public">
                  ...
                  <div class="method-subtitle deprecated">
                    Deprecated
                  </div>
                  ...
                  <div class="param-name">s2</div>
                  <div class="param-type">
                    Type: <code class="code-inline">String</code>
                  </div>
                  <div class="param-description">Works over multiple lines.</div>
                  <div class="method-subtitle">
                    Returns
                  </div>
                  <div class="method-subtitle-description">
