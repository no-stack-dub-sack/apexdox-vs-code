          ...
          <details class="section" open>
            <summary>
              <h2 class="sectionTitle" id="TEST_MultiLineTagValues">
                ...
                <a target="_blank" rel="noopener noreferrer" title="Go to source" class="hostedSourceLink" href="https://somefakeurl.com/TEST_MultiLineTagValues.cls#L7">
              ...
              <div class="methodsContainer">
                <ul class="methodTOC">
                  <li class="method public">
                    <a class="methodTOCEntry deprecated" href="#TEST_MultiLineTagValues.method1">
                      method1
                    </a>
                    <div class="methodTOCDescription">Works over multiple lines.</div>
                  </li>
                </ul>
                <div class="method public">
                  <h2 class="methodHeader deprecated" id="TEST_MultiLineTagValues.method1">method1</h2>
                  <div class="methodSignature">

                    <a target="_blank" rel="noopener noreferrer" title="Go to source" class="hostedSourceLink" href="https://somefakeurl.com/TEST_MultiLineTagValues.cls#L24">
