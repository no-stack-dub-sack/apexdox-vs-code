      ...
      <tr style="vertical-align:top;">
        ...
        <td class="contentTD">
          <details class="section" open>
            <summary>
              <h2 class="sectionTitle" id="TEST_MultiLineTagValues">
            ...
            <div class="class-details">
              <div class="">Testing that the following tags support values of multiple lines as they&#39;re supposed to. Doesn&#39;t matter if on class or method, code that handles both is the same.</div>
            </div>
            <p />
              ...
              <div class="methods-container">
                <ul class="methods-toc">
                  <li class="method public">
                    <a class="methods-toc__entry deprecated" href="#TEST_MultiLineTagValues.method1">
                      method1
                    </a>
                    <div class="methods-toc__description">Works over multiple lines.</div>
                  </li>
                </ul>
                <div class="method public">
                  <h2 class="method-title deprecated" id="TEST_MultiLineTagValues.method1">method1</h2>
                  <div class="method-signature">
                    ...
                    <a target="_blank" rel="noopener noreferrer" title="Go to source" class="source-link" href="https://somefakeurl.com/TEST_MultiLineTagValues.cls#L24">
                      public String <span class="hljs-title">method1</span>(String s2)
                    </a>
                  </div>
                  <div class="method-description">Works over multiple lines.</div>
                  <div class="method-subtitle deprecated">Deprecated</div>
                  <div class="method-subtitle-description">Works over multiple lines (deprecated).</div>
                  ...
                  <div class="method-subtitle-description">Works over multiple lines (returns).</div>
                  <div class="method-subtitle ">Exceptions</div>
                  <div class="method-subtitle-description">Works over multiple lines (exception).</div>
                  <div class="method-subtitle ">Author</div>
                  <div class="method-subtitle-description">Works over multiple lines (author).</div>
                  <div class="method-subtitle ">Since</div>
                  <div class="method-subtitle-description">Works over multiple lines (since).</div>
                </div>
              </div>
            </details>
          </details>
