        ...
        <td class="doc-page">
          ...
          <div class="section">
            ...
            <h2 class="class-title top-level-type" id="TEST_Annotations">
              ...
              <a target="_blank" rel="noopener noreferrer" title="Go to source" class="source-link" href="https://somehost.com/some-user/some-repo/tree/main/src/feature2/subFolder1/TEST_Annotations.cls#L21">
                TEST_Annotations
              </a>
            </h2>
            <div class="class-container">
              ...
              <div class="class-description">
                The Code in this class does not always need to be valid. Testing purposes only. Our annotation regex should be able to capture all of these annotations, even if this scenario is unlikely or will never happen in real life. Testing edge cases.
              </div>
              ...
              <div class="methods-container">
                ...
                <div class="method public">
                  <h4 class="method-title " id="TEST_Annotations.method1">
                    ...
                    <a target="_blank" rel="noopener noreferrer" title="Go to source" class="source-link" href="https://somehost.com/some-user/some-repo/tree/main/src/feature2/subFolder1/TEST_Annotations.cls#L27">
                      method1()
                    </a>
                  </h4>
                ...
                <div class="method private">
                  <h4 class="method-title " id="TEST_Annotations.method2">
                    ...
                    <a target="_blank" rel="noopener noreferrer" title="Go to source" class="source-link" href="https://somehost.com/some-user/some-repo/tree/main/src/feature2/subFolder1/TEST_Annotations.cls#L36">
                      method2()
                    </a>
                  </h4>
                  <div class="method-description">
                ...
                <div class="method public">
                  <h4 class="method-title " id="TEST_Annotations.method3">
                    ...
                    <a target="_blank" rel="noopener noreferrer" title="Go to source" class="source-link" href="https://somehost.com/some-user/some-repo/tree/main/src/feature2/subFolder1/TEST_Annotations.cls#L42">
                      method3()
                    </a>
                  </h4>
                  <div class="method-description">
                ...
                <div class="method public">
                  <h4 class="method-title " id="TEST_Annotations.method4">
                    ...
                    <a target="_blank" rel="noopener noreferrer" title="Go to source" class="source-link" href="https://somehost.com/some-user/some-repo/tree/main/src/feature2/subFolder1/TEST_Annotations.cls#L50">
                      method4()
                    </a>
                  </h4>
                  <div class="method-description">
