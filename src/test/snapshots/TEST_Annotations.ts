              ...
              <div class="methods-container">
                <ul class="methods-toc">
                  <li class="method public">
                    <a class="methods-toc__entry " href="#TEST_Annotations.method1">
                      method1
                    </a>
                    <div class="methods-toc__description">Several annotations over two lines.</div>
                  </li>
                  <li class="method private">
                    <a class="methods-toc__entry " href="#TEST_Annotations.method2">
                      method2
                    </a>
                    <div class="methods-toc__description">Our annotation regexp should match this annotation with params.</div>
                  </li>
                  <li class="method public">
                    <a class="methods-toc__entry " href="#TEST_Annotations.method3">
                      method3
                    </a>
                    <div class="methods-toc__description">Our annotation regexp should match this annotation</div>
                  </li>
                  <li class="method public">
                    <a class="methods-toc__entry " href="#TEST_Annotations.method4">
                      method4
                    </a>
                    <div class="methods-toc__description">Our annotation regexp should match this annotation</div>
                  </li>
                ...
                <div class="method public">
                  <h2 class="method-title " id="TEST_Annotations.method1">method1</h2>
                  <div class="method-annotations">@FirstAnnotation @SecondAnnotation @ThirdAnnotation</div>
                  ...
                  <div class="method-description">Several annotations over two lines.</div>
                </div>
                <div class="method private">
                  <h2 class="method-title " id="TEST_Annotations.method2">method2</h2>
                  <div class="method-annotations">@InvocableMethod(label='Get Account Names' description='Returns the list of account names corresponding to the specified account IDs.')</div>
                  <div class="method-signature">
                  ...
                  <div class="method-description">Our annotation regexp should match this annotation with params.</div>
                  <div class="method-subtitle ">Returns</div>
                  <div class="method-subtitle-description"><code class="code-inline">Integer</code></div>
                </div>
                <div class="method public">
                  <h2 class="method-title " id="TEST_Annotations.method3">method3</h2>
                  <div class="method-annotations">@AuraEnabled(cacheable=true)</div>
                  <div class="method-signature">
                  ...
                  <div class="method-description">Our annotation regexp should match this annotation</div>
                </div>
                <div class="method public">
                  <h2 class="method-title " id="TEST_Annotations.method4">method4</h2>
                  <div class="method-annotations">@AuraEnabled (cacheable=true)</div>
                  <div class="method-signature">
