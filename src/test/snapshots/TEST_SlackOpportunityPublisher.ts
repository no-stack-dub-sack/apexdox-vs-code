        ...
        <td class="contentTD">
          <details class="section" open>
            ...
            <div class="class-details">
              <div class="">The <code class="code-inline">SlackOpportunityPublisher</code> class. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad veniam, quis nostrud exercitation ullamco laboris nis.</div>
              ...
              <div class="subsection-container">
                <table class="attributes-table properties">
                  ...
                  <tr class="property private">
                    <td class="attribute-name">slackURL</td>
                ...
                <td class="attribute-description">The slack URL to use for publishing.</td>
            </tr>
                </table>
            </div>
            <p />
            ...
            <tr class="enum public">
                <td class="attribute-name">Days</td>
                <td class="attribute-signature">
                ...
                <td class="attribute-description">An inner enum added to demonstrate how ApexDoc2-VSCode handles inner enums. They will be presented in a table and can only have description&#39;s, like properties.</td>
            </tr>
            <tr class="enum public">
                <td class="attribute-name">Months</td>
                <td class="attribute-signature">
                ...
                <td class="attribute-description">An inner enum added to demonstrate how ApexDoc2-VSCode handles inner enums. They can only have description&#39;s, like properties. ApexDoc2 Should be able to handle to wonky way this enum is written in code.</td>
            </tr>
            <tr class="enum public">
                <td class="attribute-name">Numbers</td>
                <td class="attribute-signature">
            ...
            <tr class="enum public">
                <td class="attribute-name">Rgb</td>
                <td class="attribute-signature">
            ...
            <details class="subsection methods" open>
                ...
                <a class="methods-toc__entry " href="#TEST_SlackOpportunityPublisher.postToSlack">
                    postToSlack
                </a><div class="methods-toc__description">Incididunt ut labore et dolore magna aliqua, quis autem vel eum iure reprehenderit qui incididunt.</div></li></ul>
                <div class="method public"><h2 class="method-title " id="TEST_SlackOpportunityPublisher.postToSlack">postToSlack</h2><div class="method-annotations">@InvocableMethod(label='Post to Slack')</div>
            <div class="method-signature">
              ...
              <div class="method-description">Incididunt ut labore et dolore magna aliqua, quis autem vel eum iure reprehenderit qui incididunt.</div>
          ...
          <details class="section" open>
            ...
            <div class="class-details">
              ...
              <div class="class-subtitle ">Example</div>
...
System.enqueueJob(new QueueablePushCall(&#39;https://someurl.com&#39;, &#39;POST&#39;, body));</code></pre>
            ...
            <details class="subsection properties TEST_SlackOpportunityPublisher_QueueableSlackCall" open>
              ...
              <div class="subsection-container">
                <table class="attributes-table properties">
                  ...
                  <tr class="property private">
                    <td class="attribute-name">body</td>
                    <td class="attribute-signature">
            ...
            <tr class="property private">
                <td class="attribute-name">method</td>
                <td class="attribute-signature">
            ...
            <tr class="property private">
                <td class="attribute-name">url</td>
                <td class="attribute-signature">
            ...
            <details class="subsection methods" open>
                ...
                <a class="methods-toc__entry " href="#TEST_SlackOpportunityPublisher.QueueableSlackCall.execute">
                    execute
                </a><div class="methods-toc__description">The execute method implements the <code class="code-inline">System.Queueable</code> interface. And handle&#39;s the queueable&#39;s execution.</div></li><li class="method public">
                ...
                <div class="method public"><h2 class="method-title " id="TEST_SlackOpportunityPublisher.QueueableSlackCall.execute">execute</h2>
            <div class="method-signature">
              ...
              <div class="method-description">The execute method implements the <code class="code-inline">System.Queueable</code> interface. And handle&#39;s the queueable&#39;s execution.</div>
              <div class="method-subtitle">Parameters</div>
              <div class="paramName">ctx</div>
              <div class="paramDescription">The <code class="code-inline">System.QueueableContext</code> for the execute method.</div>
              </div>
              <div class="method public">
                <h2 class="method-title " id="TEST_SlackOpportunityPublisher.QueueableSlackCall.QueueableSlackCall">QueueableSlackCall.&lt;init&gt;</h2>
                <div class="method-signature">
